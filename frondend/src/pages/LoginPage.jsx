                ...
                <div className='w-full max-w-md p-8 space-y-6 bg-black/60 rounded-lg shadow-md'>
                    ...
                    <form className="space-y-4 " onSubmit={handleLogin}>
                        ...
                        <div>
                            ...
                            <input type="email" className="w-full px-3 py-2 mt-1 border border-gray-700 rounded-md bg-transparent 
                    ...
                    <div className="text-center text-gray-400">
                        Don&apos;t have a account? {" "}<Link to="/signup" className="text-red-500">Sign In</Link>
                    </div>
                </div>
            </div>
        </div>
