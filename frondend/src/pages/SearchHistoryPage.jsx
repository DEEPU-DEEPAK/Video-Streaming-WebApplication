...
import toast from "react-hot-toast";
	...
	useEffect(() => {
        const getSearchHistory = async () => {
            try {
                ...
                const uniqueHistory = removeDuplicates(res.data.content);
                setSearchHistory(uniqueHistory);
            } catch (error) {
                console.error('Failed to fetch search history:', error.response?.data || error.message);
                setSearchHistory([]);
	...
	const handleDelete = async (entry) => {
        try {
            ...
            console.error('Failed to delete search item:', error.response?.data || error.message);
